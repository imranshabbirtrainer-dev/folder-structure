...
const AboutPage = () => {
  ...
  const values = [
    ...
    },
    {
      icon: '💡',
      title: 'Creativity',
      description: 'Every project is an opportunity to create something unique and memorable for our users.'
    },
    {
      icon: '⚡',
      title: 'Performance',
      description: 'We optimize for speed and efficiency to ensure the best possible user experience.'
    }
  ];
          ...
          <div className="mission-content">
            <div className="mission-text">
              ...
              <p className="mission-description">
                We are dedicated to building modern, scalable, and user-friendly applications 
                that make a real difference. With years of experience in web development, 
                we understand the importance of clean code, performance optimization, and 
                exceptional user experience.
              </p>
              <p className="mission-description">
                We use the latest technologies and best practices to deliver high-quality 
                solutions that exceed our clients' expectations and drive their business forward.
              </p>
            </div>
